...
<!-- Mirrored from html.modernwebtemplates.com/qtyler/partnership.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Jun 2023 16:21:21 GMT -->
<head>
	<title>Qtyler</title>
	<meta charset="utf-8">
	<!--[if IE]>
			...
			<section class="page_topline ds background_cover">
				<div class="container-fluid">
					<div class="row flex-wrap v-center">
						...
						<a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3b4a4f42575e497b5e435a564b575e15585456">[email&#160;protected]</a>
					</span> <span>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <img src="images/partners/01.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/02.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/03.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/04.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/05.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/06.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/07.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/08.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
                            <img src="images/partners/09.jpg" alt="">
                        </a> </div>
								<div class="isotope-item col-xs-4 col-sm-3"> <a href="#" class="with_shadow">
						...
						<div class="col-xs-12 col-md-6">
							<div class="isotope_container isotope row masonry-layout images-grid columns_margin_bottom_20">
								<div class="isotope-item col-xs-6">
									<div class="with_shadow text-center"> <img src="images/features/01.jpg" alt=""> </div>
								</div>
								<div class="isotope-item col-xs-6">
									<div class="with_shadow text-center"> <img src="images/features/02.jpg" alt=""> </div>
								</div>
								<div class="isotope-item col-xs-6">
									<div class="with_shadow text-center"> <img src="images/features/03.jpg" alt=""> </div>
								</div>
								<div class="isotope-item col-xs-6">
									<div class="with_shadow text-center"> <img src="images/features/04.jpg" alt=""> </div>
								</div>
							</div>
						</div>
					</div>
								...
								<ul class="list-unstyled greylinks">
									...
									<li>
										<div class="media small-media">
											...
											<div class="media-body"> <a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection#d3f0"><span class="__cf_email__" data-cfemail="addcd9d4c1c8dfedc8d5ccc0ddc1c883cec2c0">[email&#160;protected]</span></a> </div>
										</div>
									</li>
									<li>
										<div class="media small-media">
...
<!-- Mirrored from html.modernwebtemplates.com/qtyler/partnership.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Jun 2023 16:21:25 GMT -->
</html>