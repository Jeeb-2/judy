...
<!-- Mirrored from html.modernwebtemplates.com/qtyler/copyright4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Jun 2023 16:21:34 GMT -->
<head>
	<title>Qtyler</title>
	<meta charset="utf-8">
	<!--[if IE]>
			...
			<section class="page_topline ds background_cover">
				<div class="container-fluid">
					<div class="row flex-wrap v-center">
						...
						<a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e09194998c8592a08598818d908c85ce838f8d">[email&#160;protected]</a>
					</span> <span>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-12 display-flex v-center">
							<div class="header_left_logo"> <a href="index-2.html" class="logo">
...
eof Gallery right sidebar -->
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center">
							<h1 class="sr-only">Copyright 4</h1>
							<ol class="breadcrumb darklinks">
								<li> <a href="index-2.html">
							Home
						</a> </li>
								<li> <a href="#">Features</a> </li>
								<li class="active"> <span>Copyright 4</span> </li>
							</ol>
						</div>
					</div>
				</div>
			...
			<footer class="page_footer parallax overlay_color ds ms section_padding_top_150 section_padding_bottom_150 columns_padding_30">
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-12">
							<div class="widget widget_text">
								<div class="logo"> <img src="images/logo-dark.png" alt=""> </div>
								<p> Consetetur sadipscing elitr diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erased diam voluptua aero eos et accusam et justo. Duo dolores etea rebum. clita kasd. </p>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="widget">
								<h3 class="widget-title">Mail form</h3>
								<form class="contact-form" method="post" action="https://html.modernwebtemplates.com/qtyler/">
									<p class="form-group"> <label for="footer-name">Full Name <span class="required">*</span></label> <i class="fa fa-user highlight"></i> <input type="text" aria-required="true" size="30" value="" name="name" id="footer-name" class="form-control with_icon" placeholder="Name">										</p>
									<p class="form-group"> <label for="footer-email">Email address<span class="required">*</span></label> <i class="fa fa-envelope highlight"></i> <input type="email" aria-required="true" size="30" value="" name="email" id="footer-email" class="form-control with_icon"
										    placeholder="Email Address"> </p>
									<p class="form-group"> <label for="footer-message">Message</label> <i class="fa fa-pencil highlight"></i> <textarea aria-required="true" rows="3" cols="45" name="message" id="footer-message" class="form-control with_icon" placeholder="Message"></textarea> </p>
									<p class="contact-form-submit topmargin_40">
									<button type="submit" id="footer_contact_form_submit" name="contact_submit" class="theme_button min_width_button">Send</button> </p>
								</form>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="widget">
								...
								<div class="media small-teaser">
									...
									<div class="media-body"> PO Box 97845 Some str. 567, Los Angeles, California, United States </div>
								</div>
								<div class="media small-teaser">
									<div class="media-left"> <i class="rt-icon2-device-phone highlight fontsize_24"></i> </div>
									<div class="media-body"> +65 (800) 695-2684 </div>
								</div>
								<div class="media small-teaser">
									<div class="media-left"> <i class="rt-icon2-printer2 highlight fontsize_24"></i> </div>
									<div class="media-body"> +65 (800) 695-2686 </div>
								</div>
								<div class="media small-teaser">
									<div class="media-left"> <i class="rt-icon2-mail2 highlight fontsize_24"></i> </div>
									<div class="media-body"> <a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection#b0c9dfc5c2f0ddd1d9dc9ed3dfdd"><span class="__cf_email__" data-cfemail="dfa6b0aaad9fb2beb6b3f1bcb0b2">[email&#160;protected]</span></a> </div>
								</div>
								<div class="topmargin_20"> <a href="#" class="social-icon color-bg-icon socicon-facebook"></a><a href="#" class="social-icon color-bg-icon socicon-twitter"></a><a href="#" class="social-icon color-bg-icon socicon-google"></a><a href="#" class="social-icon color-bg-icon socicon-linkedin"></a>
									<a
									    href="#" class="social-icon color-bg-icon socicon-pinterest"></a>
								</div>
							</div>
						</div>
					</div>
